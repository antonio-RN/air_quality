...
for i in range(2, index):
    ...
    os.remove(f"../data/02_intermediate/air_quality_df_{i}.parquet")
```
...
magnitude = random.sample(list(magnitudes), 1)[0]
...
row2 = base.encode(
    ...
    y=alt.Y("mean(VALOR):Q", title=f"{magnitude} [{unit}]")
