from src.nodes import input_raw_data, input_missing_data
...
dd_pivoted = dd_raw_reduced.map_partitions(nodes.pivoting_raw_data, meta=nodes.pivoting_raw_data(dd_raw_reduced.head(1)))
dd_datetime = dd_pivoted.map_partitions(nodes.transform_datetime, meta=nodes.transform_datetime(dd_pivoted.head(1)))
...
# gdd_bronze.to_parquet(parameters.bronze_geofile)